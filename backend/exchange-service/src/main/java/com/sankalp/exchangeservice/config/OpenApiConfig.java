package com.sankalp.exchangeservice.config;
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .description("RESTful API for managing stock exchanges in the Stock Market Application")
                        .version("1.0.0")
                        .contact(new Contact()
                ...
                .tags(List.of(
                        new Tag()
                                ...
                                .description("Operations for managing stock exchanges")));
    }
}
